...
int64_t GetSporkValue(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
        ...
        if (nSporkID == SPORK_10_TOKENGROUP_MANAGEMENT_MODE) r = SPORK_10_TOKENGROUP_MANAGEMENT_MODE_DEFAULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_10_TOKENGROUP_MANAGEMENT_MODE") return SPORK_10_TOKENGROUP_MANAGEMENT_MODE;
...
std::string CSporkManager::GetSporkNameByID(int id)
{
    ...
    if (id == SPORK_10_TOKENGROUP_MANAGEMENT_MODE) return "SPORK_10_TOKENGROUP_MANAGEMENT_MODE";

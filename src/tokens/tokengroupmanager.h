...
public:
    ...
    bool MagicTokengroupCreated();
    bool DarkMatterTokengroupCreated();
    bool AtomTokengroupCreated();

    bool ManagementTokensCreated() {
        return MagicTokengroupCreated() && DarkMatterTokengroupCreated() && AtomTokengroupCreated();
    }

...
bool CMasternodeSync::IsBlockchainSynced()
{
    ...
    if (pindex->nTime + 60 * 60 < GetTime() && Params().NetworkID() != CBaseChainParams::REGTEST)
        return false;
...
void CMasternodeSync::GetNextAsset()
{
    ...
    case (MASTERNODE_SYNC_FAILED): // should never be used here actually, use Reset() instead
        ...
        RequestedMasternodeAssets = Params().NetworkID() != CBaseChainParams::REGTEST ? MASTERNODE_SYNC_SPORKS : MASTERNODE_SYNC_FINISHED;
        break;
